					...
					<tbody>
						...
						$i = 1;
						 ...
						 <tr>
						 	...
						 	<td>
								 <p><?php echo "<img src='img_dir/".$row['avatar']."' class='img-fluid img-thumbnail' alt='image'>"; ?></p>
								...
								<p><?php echo "<img src='uploads/".$row['g_avatar']."' class='img-fluid img-thumbnail' alt='image'>"; ?></p>
